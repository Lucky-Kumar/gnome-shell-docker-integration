 ...
 * Copyright (C) 2019 Fausto Ramírez <faustor21@gmail.com>
 ...
 */
var isDockerRunning = () => {
  // Find fully qualify path for the 'ps' program
  const psPath = GLib.find_program_in_path('ps')
 ...
 */
var async = (fn, callback) =>
  GLib.timeout_add(GLib.PRIORITY_DEFAULT, 0, () => callback(fn()))
